    ...
    >
      <div className="flex justify-between items-center max-w-screen-xl mx-auto px-4">
        <div className="flex justify-between items-center w-full md:w-auto">
          <h1 className="text-bold text-3xl md:text-5xl font-bold">
            Mahery RAKOTOMALALA
          </h1>
        ...
        <div
          className={clsx(
            ...
            {
              "flex flex-col items-center w-full mt-4 md:mt-0 md:w-auto":
                menuOpen,
            }
          )}
        >
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-5 justify-center items-center mt-4 md:mt-0">
            ...
            <div className="flex gap-3">
              ...
              <Button variant="contained">Mes Projets</Button>
            </div>
          </div>
        </div>
      </div>
      {menuOpen && (
        <div className="absolute top-0 left-0 w-full h-screen bg-white dark:bg-black flex flex-col justify-start items-start p-8 z-40">
          <div className="flex justify-between items-center w-full mb-8">
            <h1 className="text-bold text-3xl md:text-5xl font-bold -mt-5 -ml-4">
              Cyclops
            </h1>
            <button
