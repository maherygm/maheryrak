...
import { IconCloudDemo } from "@/presentation/customComponents/iconCloud";
  ...
  return (
    <div className="w-[80%] relative mx-auto my-9 flex flex-col gap-10 py-40">
      <div className="flex relative flex-col gap-6 items-center justify-center">
        <h1 className="text-7xl">Mes Competences</h1>
      ...
      <div className="w-full flex items-center justify-center ">
        <div>
          <h1 className="text-center text-8xl">Mes Langage et Framework</h1>
        </div>
        <IconCloudDemo />
      </div>
    </div>
